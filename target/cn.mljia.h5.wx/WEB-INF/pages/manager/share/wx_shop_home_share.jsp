	...
	<ul class="userdatas01">
     ...
     {{# }else if(d.customStatus==1){ }}
        ...
        {{# }else if(d.customStatus==2) { }}
			<li class="list03">
			  <p class="mt92">
				<a class="abutbese abut_pink"  href="<%=request.getContextPath()%>/agent/meirong-user-user_bind_from_shop?userId={{ d.userId}}&appId={{ d.appId }}&openId={{ d.openId}}&shopId={{ d.shopId}}">加入商家</a>
			  </p>
            </li>
        {{# } }}
...
<script src="<%=request.getContextPath()%>/resources/javascript/manager/share/wx_shop_home_share.js"></script>
