(function(){
	...
	var server = "http://o2o.mljia.cn";
	
	var imageRoot  = "http://download.mljia.cn";
	
	
	var zhifuUrl = "http://h5.mljia.cn/wx/pay";		//生产环境 为http://h5.mljia.cn/wx/pay //外网test02测试环境: http://test.mljia.cn/wx/pay  //test环境和dev环境： http://dev.mljia.cn/wx/pay
	
	var zhifuUrlLis ="http://h5.mljia.cn/wx/paytwo";  //生产环境 为 http://h5.mljia.cn/wx/paytwo   //外网test02测试环境: http://test.mljia.cn/wx/pay  //test环境和dev环境：http://dev.mljia.cn/wx/pay
	
	var WXserver    =  "http://wx.mljia.cn";           //获取accessToken 上传图片等 //生产环境     "http://wx.mljia.cn";  内网："http://dev.mljia.cn/wxpub"
