														        ...
														        $.ajax({
														        	...
														        	success :function(data){
														        		...
														        		//	alert("保存到mljia服务器的localImgId："+localImgId);
														        			var imgItem = $("<li class='poi1' ><div style='display:inline-block;position:relative' id="+ localImgId+ 
																				          "><img src=' "+data.data.small_url +" ' width='97' height='99' ></div>"+
																				          "<a class='poi2' herf='javascript: ;'style='position:relative' >"+"<img src= ' " + GLOBAL.webRoot+ 
