...
.pickerinput {width:180px;text-align:left;background: none;font-size: 24px; z-index: 10;cursor: pointer; border: 1px solid #ff5ebd; color: #ff5ebd; border-radius: 10px; margin-top:15px;}

input:focus{border:none;}
.picker-items-col.picker-items-col-center{width:100%}
.picker-selected{background-color:#F7F7F7}
.index_top_choose_shop{width:220px}
 ...
 <div class="shopmanmain wx_guanlian bghui">
        ...
        <script type="text/html" id="recommendProListTmpl"  title="店铺推荐模板">
			<div class="supervisor_tj_title">
                ...
                <a href="javascript:;" class="btn_more shop_advice">
					<span>更多&nbsp;</span>
					<font></font>
				</a>
            </div>
         ...
         <div class="supervisor_tj" id="hotProView"  title="热销产品"></div>
          ...
          <script type="text/html" id="hotProListTmpl"  title="热销产品">
			<div class="supervisor_tj_title">
                ...
                <a href="javascript:;" class="btn_more more_prod">
					<span>更多&nbsp;</span>
					<font></font>
				</a>
            </div>
...
<script src="<%=request.getContextPath()%>/resources/javascript/manager/shop/info/wx_shops_home.js"></script>
