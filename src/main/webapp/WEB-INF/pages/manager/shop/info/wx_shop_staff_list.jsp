...
<script type="text/html" id="shopStaffTmpl">
   <div class="shopmanmain wx_guanlian ">
	...
	<ul class="staff_list_ul">
		...
		{{# }else{  }}
			<li class="staff_list_pic" style="background-image:url( {{ d.webRoot}}/resources/images/img/defaults/staffHeadDefault3.png)"></li>
        {{# } }}
		<li class="lh40">
		...
		{{# if( item.staff_mobile ) { }}
			<li class="staff_list_but"><a class="but0 but1" href="tel:{{ item.staff_mobile }}"><i  class="icon-staff_list"></i>立即咨询</a></li>
        {{# }else { }}
			<li class="staff_list_but"><a class="but0 "><i class="icon-staff_list"></i>立即咨询</a></li>
...
<!-- 外部js资源文件引入 -->
<script src="<%=request.getContextPath()%>/resources/javascript/manager/shop/info/wx_shop_staff_list.js"></script>
