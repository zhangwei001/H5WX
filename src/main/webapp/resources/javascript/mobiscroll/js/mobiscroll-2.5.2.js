...
(function ($) {
    ...
    function Scroller(elem, settings) {
        ...
        function generateWheelItems(i,name) {
            ...
            for (j in warr[i]) {
                ...
                html += '<div class="dw-li dw-v" data-val="' + j + '" style="height:' + hi + 'px;line-height:' + hi + 'px;"><div class="dw-i">' + warr[i][j] + name+'</div></div>';
                l++;
            }
            html += '</div>';
            return html;
        ...
        */
        that.show = function (prevAnim) {
            ...
            html+='<div class="dwv-title">请选择您的到店时间</div>';
            /*截掉头部时间 + (s.headerText ? '<div class="dwv"></div>' : '')*/
            ...
            for (i = 0; i < s.wheels.length; i++) {
                ...
                for (label in s.wheels[i]) {
                    ...
                    // Create wheel values
                    html += generateWheelItems(l,label);
            ...
            html += (s.display != 'inline' ? '<div class="dwbc' + (s.button3 ? ' dwbc-p' : '') + '"><span class="dwbw dwb-s"><span class="dwb">' + s.setText + '</span></span>' + (s.button3 ? '<span class="dwbw dwb-n"><span class="dwb">' + s.button3Text + '</span></span>' : '') + '</span></div></div>' : '<div class="dwcc"></div>') + '</div></div></div>';
            dw = $(html);
